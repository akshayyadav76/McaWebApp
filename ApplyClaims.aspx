<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyClaims.aspx.cs" Inherits="McaWebApp.ApplyClaims" %>
				...
				<tr>
					...
					<div align="center">
						<table border="1" width="573" cellspacing="1" style="border-collapse: collapse" bordercolor="#999999" id="table2">
							<tr>
								<td class="td2">
								<p align="left">&nbsp; WCPS : Apply Claim</td>
							</tr>
							<tr>
								<td>
								<table border="0" width="97%" id="table3" cellpadding="2">
									...
									<tr>
										...
										<td class="td1" align="left" valign="top">&nbsp;<asp:TextBox ID="TxtClaimType" runat="server"></asp:TextBox>&nbsp;</td>
									</tr>
									<tr>
										<td width="54" class="td1" align="left" valign="top">&nbsp;</td>
